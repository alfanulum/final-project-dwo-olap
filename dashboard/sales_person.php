                                    ...
                                    <tfoot class="table-active">
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <strong>
                                                    <?= 
                                                        $overallStats['achievement_rate'] >= 100 ? 'Exceed Target' : 
                                                        ($overallStats['achievement_rate'] >= 80 ? 'On Track' : 'Below Target')
                                                    ?>
                                                </strong>
                                            </td>
                                            <td></td>
                                ...
                                <?php foreach ($topSales as $index => $top): ?>
                                    <div class="col-md-4 mb-3">
                                        <div class="card h-100 border-<?= 
                                            $top['performance_status'] == 'Exceed Target' ? 'success' : 
                                            ($top['performance_status'] == 'On Track' ? 'primary' : 'warning')
                                        ?>">
                                            <div class="card-body">
                                                ...
                                                <div class="row text-center">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <h5 class="text-<?= 
                                                            $top['achievement_rate'] >= 100 ? 'success' : 
                                                            ($top['achievement_rate'] >= 80 ? 'primary' : 'warning')
                                                        ?>">
